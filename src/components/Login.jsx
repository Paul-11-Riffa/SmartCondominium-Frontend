...
// La variable de entorno para la URL de la API
const API_URL = import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000';

// --- ¡LA CORRECCIÓN ESTÁ AQUÍ! ---
// Añadimos 'switchToRegister' a las props que recibe el componente
                ...
                {usuario ? (
                    ...
                    <div className="form-container">
                        ...
                        <p className="register-link">
                            ¿No tienes una cuenta? <button type="button" className="link-button"
                                                           onClick={switchToRegister}>Regístrate aquí</button>
                        </p>
