...
import { FaTachometerAlt, FaUsers, FaDollarSign, FaShieldAlt, FaBuilding, FaTools, FaBullhorn, FaCog, FaSignOutAlt, FaHome, FaFileInvoiceDollar, FaCalendarAlt, FaUserFriends, FaHistory } from 'react-icons/fa';
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="nav-item">
        <button onClick={() => setActiveView('configuracion')} className={`nav-link ${activeView === 'configuracion' ? 'active' : ''}`}>
